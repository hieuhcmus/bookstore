...
INSERT INTO PAYMENT (ID, FIRST_NAME ,LAST_NAME,BILLING_ADDRESS_ID, SHIPPING_ADDRESS_ID, CARD_TYPE, CARD_NO, EXP_MONTH_YEAR, CVC, AVAILABLE_BALANCE, LIMIT_AMOUNT, ENABLED)
